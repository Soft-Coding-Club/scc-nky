...
2. Deploy. The root URL serves only the Archive index; each work is available at the paths above.

All projects are static, so the archive can also be published with GitHub Pages.
